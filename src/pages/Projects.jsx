...
function Projects() {
  return (
    <div className=" bg-gray-900 text-white  px-6 py-4 md:px-20 min-h-screen pt-24">
      <MetaData
      ...
      <h2 className="flex justify-center py-4 text-2xl mb-6">
        My recent works
      </h2>
              ...
              <div className="flex justify-between items-center px-4 p-2 mt-3">
                <div className="flex justify-center items-center gap-2 hover:text-gray-300 bg-black rounded-4xl text-black py-4 px-6 hover:bg-blue-900 transition-colors cursor-pointer">
                  ...
                  >
                    <BsGithub
                      size={20}
                      className="transition-all duration-150 ease-in  text-bold"
                    />
